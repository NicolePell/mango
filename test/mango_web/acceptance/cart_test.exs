defmodule MangoWeb.CartTest do
  use Mango.DataCase
  use Hound.Helpers
  ...
  setup do
    ...
    Repo.insert %Product{ name: "Carrot", pack_size: "1 kg", price: 0.65, sku: "A123", is_seasonal: true }
    Repo.insert %Product{ name: "Apple", pack_size: "1 kg", price: 0.15, sku: "B123", is_seasonal: true }
