defmodule Mango.Catalog do
  ...
  def list_products do
    product_one = %Product{ name: "Tomato", price: 50, is_seasonal: false, category: "vegetables" }
    product_two = %Product{ name: "Apple", price: 100, is_seasonal: true, category: "fruits" }
